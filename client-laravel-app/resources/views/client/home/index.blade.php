...
<div class="font-inter">
    ...
    <section class="relative h-[70vh] min-h-[500px] max-h-[600px] overflow-hidden gradient-bg">
        <!-- Slides Container -->
    ...
    <!-- Latest Updates Section - Moved directly after hero for better UX flow -->
    <section class="py-5 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Simplified header - more space efficient -->
            <div class="flex items-center justify-between mb-10">
                <div>
                    <h2 class="text-3xl md:text-4xl font-bold text-gray-900">Latest Updates</h2>
                    <div class="w-16 h-1 bg-gradient-to-r from-green-500 to-green-600 mt-2"></div>
                </div>
                <!-- Compact Tab Navigation -->
            <div class="mt-10 mb-5">
                <div class="relative">
                    <div class="flex space-x-1 bg-gray-100 p-1 rounded-lg inline-flex">
                        <button class="tab-btn active px-4 py-2 rounded-md font-medium text-sm transition-all text-gray-600 hover:text-green-600 relative" data-tab="opportunities">
                            Opportunities
                        </button>
                        <button class="tab-btn px-4 py-2 rounded-md font-medium text-sm transition-all text-gray-600 hover:text-green-600 relative" data-tab="news">
                            News
                        </button>
                        <button class="tab-btn px-4 py-2 rounded-md font-medium text-sm transition-all text-gray-600 hover:text-green-600 relative" data-tab="resources">
                            Resources
                        </button>
                        <button class="tab-btn px-4 py-2 rounded-md font-medium text-sm transition-all text-gray-600 hover:text-green-600 relative" data-tab="blogs">
                            Blogs
                        </button>
                    </div>
                </div>
            ...
            <div class="tab-content">
                ...
                <div id="opportunities" class="tab-pane active">
                        ...
                        <div class="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden group hover:-translate-y-1 border border-gray-100">
                            <div class="h-40 {{ ['bg-gradient-to-br from-green-400 to-green-600', 'bg-gradient-to-br from-blue-400 to-blue-600', 'bg-gradient-to-br from-purple-400 to-purple-600', 'bg-gradient-to-br from-yellow-400 to-yellow-600', 'bg-gradient-to-br from-red-400 to-red-600', 'bg-gradient-to-br from-indigo-400 to-indigo-600'][($loop->index) % 6] }} relative overflow-hidden"
                                ...
                                <div class="absolute top-3 right-3">
                                    <span class="bg-black/20 backdrop-blur-sm text-white px-2 py-1 rounded-md text-xs">
                                        {{ \Carbon\Carbon::parse($event->start_date)->format('M d') }}
                                    </span>
                                </div>
                            </div>
                            <div class="p-5">
                                <h3 class="text-lg font-bold text-gray-900 mb-2 group-hover:text-green-600 transition-colors line-clamp-2">
                                    {{ $event->title }}
                                </h3>
                    ...
                    <div class="text-center mt-8">
                        <a href="{{ route('events.public') }}" 
                           class="bg-green-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-green-700 transition-colors inline-flex items-center">
                    ...
                    <div class="text-center py-12">
                        ...
                        <p class="text-gray-600">New volunteer opportunities will be posted here regularly.</p>
                    </div>
                    @endif
                </div>
                ...
                <div id="news" class="tab-pane hidden">
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden group hover:-translate-y-1 border border-gray-100">
                            <div class="h-40 bg-gradient-to-br from-gray-400 to-gray-600 relative overflow-hidden"
                                ...
                                <div class="absolute top-3 right-3">
                                    <span class="bg-black/20 backdrop-blur-sm text-white px-2 py-1 rounded-md text-xs">
                                        {{ optional($news->published_at)->format('M d') }}
                                    </span>
                                </div>
                            </div>
                            <div class="p-5">
                                ...
                                <p class="text-gray-600 text-sm mb-4 line-clamp-2">{{ Str::limit(strip_tags($news->content), 100) }}</p>
                                <div class="flex justify-between items-center">
                                    <span class="text-xs text-gray-500">{{ optional($news->published_at)->format('M d, Y') }}</span>
                    ...
                    <div class="text-center py-12">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-2">No News Available</h3>
                        <p class="text-gray-600">Latest news and updates will be posted here.</p>
                    </div>
                    @endif
                </div>
                ...
                <div id="resources" class="tab-pane hidden">
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden group hover:-translate-y-1 border border-gray-100">
                            <div class="p-5">
                                ...
                                <p class="text-gray-600 text-sm mb-4">{{ Str::limit($resource->description, 120) }}</p>
                                <div class="flex justify-between items-center">
                                    <span class="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded-full">{{ $resource->type ?? 'Resource' }}</span>
                                    @auth
                                        <a href="{{ route('resources.public.show', $resource->slug) }}" 
                                           class="text-green-600 font-semibold hover:text-green-700 transition-colors text-sm" target="_blank">
                                            View →
                                        </a>
                                    @else
                                        <span class="text-gray-400 text-xs">Login Required</span>
                                    @endauth
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="text-center py-12">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-2">No Resources Available</h3>
                        <p class="text-gray-600">Training materials and guides will be available here.</p>
                    </div>
                    @endif
                </div>
                ...
                <div id="blogs" class="tab-pane hidden">
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div class="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden group hover:-translate-y-1 border border-gray-100">
                            <div class="h-40 bg-gradient-to-br from-gray-400 to-gray-600 relative overflow-hidden"
                                ...
                                <div class="absolute top-3 right-3">
                                    <span class="bg-black/20 backdrop-blur-sm text-white px-2 py-1 rounded-md text-xs">
                                        {{ optional($blog->published_at)->format('M d') }}
                                    </span>
                                </div>
                            </div>
                            <div class="p-5">
                                ...
                                <div class="flex justify-between items-center">
                                    <span class="text-xs text-gray-500">{{ optional($blog->published_at)->format('M d, Y') }}</span>
                    ...
                    <div class="text-center py-12">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-2">No Blog Posts Available</h3>
                        <p class="text-gray-600">Inspiring stories and insights will be shared here.</p>
                    </div>
                    @endif
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                @if(isset($page_sections) && count($page_sections) > 0)
                    ...
                    <div class="group bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100">
                        <div class="w-12 h-12 {{ ['bg-gradient-to-br from-green-500 to-green-600', 'bg-gradient-to-br from-yellow-400 to-yellow-500', 'bg-gradient-to-br from-blue-500 to-blue-600', 'bg-gradient-to-br from-purple-500 to-purple-600'][$index % 4] }} rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                            @if($section->image)
                                <img src="{{ asset('storage/sections/' . $section->image) }}" alt="{{ $section->title }}" class="w-6 h-6 object-contain">
                            @else
                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        @endif
                        <h3 class="text-lg font-bold text-gray-900 mb-3 group-hover:text-green-600 transition-colors">{{ $section->title }}</h3>
                ...
                @else
                    ...
                    <div class="group bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100">
                        ...
                        <a href="{{ route('events.index') }}" class="text-decoration-none">
                            <h3 class="text-lg font-bold text-gray-900 mb-3 group-hover:text-green-600 transition-colors">Volunteer Opportunities</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Access thousands of volunteer opportunities across education, healthcare, environment, and technology sectors.</p>
                        </a>
                    </div>
                    
                    <div class="group bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100">
                        <div class="w-12 h-12 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('about') }}" class="text-decoration-none">
                            <h3 class="text-lg font-bold text-gray-900 mb-3 group-hover:text-green-600 transition-colors">Skill Development</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Develop professional skills through training programs and hands-on volunteer experience with certified outcomes.</p>
                        </a>
                    </div>
                    ...
                    <div class="group bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100">
                        ...
                        <a href="{{ route('resources.index') }}" class="text-decoration-none">
                            <h3 class="text-lg font-bold text-gray-900 mb-3 group-hover:text-green-600 transition-colors">Pan-African Network</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Connect with volunteers, organizations, and communities across all 55 African Union member states.</p>
                        </a>
                    </div>
                    ...
                    <div class="group bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100">
                        ...
                        <a href="#" class="text-decoration-none">
                            <h3 class="text-lg font-bold text-gray-900 mb-3 group-hover:text-green-600 transition-colors">Impact Tracking</h3>
                            <p class="text-gray-600 text-sm leading-relaxed">Track your volunteer impact with detailed analytics, certificates, and recognition for your contributions.</p>
                        </a>
                    </div>
                @endif
            </div>
    ...
    <section class="py-16 gradient-bg">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
                <div class="group">
                    <div class="text-4xl lg:text-5xl font-bold text-white mb-3 group-hover:scale-110 transition-transform">
                        {{ isset($statistics['volunteers']) ? number_format($statistics['volunteers']) : '2.5K+' }}
                    </div>
                    <div class="text-lg text-gray-200">Active Volunteers</div>
                </div>
                <div class="group">
                    <div class="text-4xl lg:text-5xl font-bold text-yellow-400 mb-3 group-hover:scale-110 transition-transform">
                        {{ isset($statistics['organizations']) ? number_format($statistics['organizations']) : '150+' }}
                    </div>
                    <div class="text-lg text-gray-200">Partner Organizations</div>
                </div>
                <div class="group">
                    <div class="text-4xl lg:text-5xl font-bold text-white mb-3 group-hover:scale-110 transition-transform">
                        {{ isset($statistics['countries']) ? number_format($statistics['countries']) : '55' }}
                    </div>
                    <div class="text-lg text-gray-200">African Countries</div>
                </div>
                <div class="group">
                    <div class="text-4xl lg:text-5xl font-bold text-yellow-400 mb-3 group-hover:scale-110 transition-transform">
                        {{ isset($statistics['projects']) ? number_format($statistics['projects']) : '500+' }}
                    </div>
                    <div class="text-lg text-gray-200">Projects Completed</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="bg-gradient-to-r from-green-50 to-green-100 rounded-3xl p-10">
                <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                    <a href="{{ route('registration.volunteer.start') }}" 
                       class="bg-green-600 text-white px-8 py-3 rounded-xl font-semibold text-lg hover:bg-green-700 transition-all hover-scale shadow-lg">
                        Join as Volunteer
                    </a>
                    <a href="{{ route('registration.organization.step', 'organization_details') }}" 
                       class="bg-white text-green-600 border-2 border-green-600 px-8 py-3 rounded-xl font-semibold text-lg hover:bg-green-600 hover:text-white transition-all hover-scale">
                ...
                <div class="pt-6 border-t border-green-200">
                    <p class="text-gray-600 mb-3 text-sm">Already have an account?</p>
                    <a href="{{ route('login') }}" 
                       class="inline-block border-2 border-green-600 text-green-600 px-6 py-2 rounded-lg font-semibold hover:bg-green-600 hover:text-white transition-all">
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-10 items-center">
                ...
                <div>
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">Follow Our Journey</h3>
                    <p class="text-gray-600 mb-6">Stay connected with AU-VLP on social media for real-time updates, success stories, and community highlights.</p>
                    
                    <!-- Social Media Links -->
                    <div class="flex flex-wrap gap-3 mb-6">
                        <a href="https://twitter.com/AfricanUnion" target="_blank" rel="noopener noreferrer" 
                           class="flex items-center space-x-2 bg-white p-3 rounded-xl shadow-md hover:shadow-lg transition-all hover:-translate-y-1">
                            ...
                            <span class="font-medium text-gray-900 text-sm">Twitter</span>
                        </a>
                        ...
                        <a href="https://www.facebook.com/AfricanUnionCommission" target="_blank" rel="noopener noreferrer" 
                           class="flex items-center space-x-2 bg-white p-3 rounded-xl shadow-md hover:shadow-lg transition-all hover:-translate-y-1">
                            ...
                            <span class="font-medium text-gray-900 text-sm">Facebook</span>
                        </a>
                        ...
                        <a href="https://www.linkedin.com/company/african-union" target="_blank" rel="noopener noreferrer" 
                           class="flex items-center space-x-2 bg-white p-3 rounded-xl shadow-md hover:shadow-lg transition-all hover:-translate-y-1">
                            ...
                            <span class="font-medium text-gray-900 text-sm">LinkedIn</span>
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-lg">
                    ...
                    <p class="text-gray-600 mb-4 text-sm">Subscribe to our newsletter for the latest volunteer opportunities, success stories, and AU-VLP updates.</p>
                    
                    <form action="{{ route('newsletter.subscribe') }}" method="POST" class="space-y-4">
                        @csrf
                        <div>
                            <input type="email" name="email" placeholder="Enter your email address" required
                                   class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm">
                        </div>
                        ...
                        <button type="submit" class="w-full bg-green-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-green-700 transition-colors">
                            Subscribe Now
                        </button>
                    </form>
                </div>

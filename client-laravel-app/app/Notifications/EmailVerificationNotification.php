...
class EmailVerificationNotification extends Notification implements ShouldQueue
{
    ...
    protected function buildMailMessage(string $url): MailMessage
    {
        return (new MailMessage)
            ->subject('Verify Your Email Address - African Universities VLP')
            ->greeting('Hello!')
            ->line('Welcome to the African Universities Volunteer Learning Platform!')
            ...
            ->salutation('The African Universities VLP Team')
            ->with([

...
class OpportunityCategory extends Model
{
    ...
    {
        return $this->hasMany(Opportunity::class, 'category_id')->active();
    }
    ...
    public function getActiveOpportunitiesCount()
    {
        return $this->activeOpportunities()->count();
    }

    public function getUrl()
    {
        return route('opportunities.category', $this->slug);
    }
}
